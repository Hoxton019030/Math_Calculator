  ...
  <div class="container py-4 d-flex">
    ...
    <div class="main-content">
      ...
      <div class="mb-3 d-flex gap-2 flex-wrap align-items-center">
        ...
        <input v-model="inputText" type="text" class="form-control" :placeholder="graphMode === 'directed'
    ...
    <div class="ms-4">
      <HistoryPanel :history="history" @clearHistory="clearHistory" @loadHistoryItem="loadHistoryItem" />
    </div>
